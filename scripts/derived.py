...
ALIASES = {
    ...
    "成本":   ["营业成本", "销售成本", "减：营业成本"],
    "毛利":   ["毛利 ", "毛利"],
    "销售费用": ["销售费用", "销售及分销开支", "减：销售费用", "销售及市场推广开支"],
    "管理费用": ["管理费用", "行政开支", "减：管理费用", "一般及行政开支"],  # 港股「行政开支」≈ A股「管理费用」
    "研发费用": ["研发费用", "减：研发费用", "研发开支"],
    "净利润": ["净利润 ", "净利润", "四、净利润", "五、净利润", "年内溢利", "年度盈利"],
    "归母":   ["归属于母公司股东的净利润", "归属于母公司所有者的净利润", "归属于上市公司股东的净利润",
              "母公司拥有人应占溢利", "归母净利润", "归母净利"],
    ...
    "预付":   ["预付款项", "预付账款"],
    "PPE":    ["固定资产", "物业、厂房及设备", "物业厂房设备", "物业厂房及设备", "物业设备及器材"],
