...
#
# ⚠️ 不要把港股「翌日披露报表」(FF305) / 「月报表」(FF301) 加回来：
# 它们标题看似例行，实为港股**股份购回的权威一手载体**（逐日购回明细 / 月度股本变动与注销）。
# 2026-08~09 期间共 14 次把腾讯回购一手件折叠成「例行公告」，每次都要靠人工展开才捞回。
NOISE_PAT = re.compile(
    r"法律意见书|独立董事|监事会决议|持股.*简式权益|更正公告|英文版|"
    r"持续关连交易之"
)
