...
- **知识库**
  - `finance/<公司>/` — 公司客观分析三件套（`财务数据/<csv>` + `分析.md` + `财报关注要点.md`，canonical 客观数据；**不出现任何主观决策**）·已覆盖 A 股 / 港股 / **首家美股**（`google` = Alphabet 年度 2002–2025 + **2026 中期(Q2 10-Q)**，SEC EDGAR + XBRL + 10-Q 管线跑通）
...
- **知识库**：`judgments/<公司>/`（2026-07-08 骨架已建·纯我的主观判断·**无大V署名·无客观数据双写**）
  - `估值.md` — 合理 PE = 1/你能锁定的最低无风险利率 + 买卖点(覆盖式)
